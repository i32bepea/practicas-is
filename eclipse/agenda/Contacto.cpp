 ...
 *
 * 			-El switch dentro del metodo se recorre de manera automatica, de esta manera se controla
 * 			mas facilmente que el cliente no meta ningun valor incorrecto.
 *			-Los string del metodo se leen con 'getline' en vez de hacerlo directamente con
 *			el stream de entrada 'i' ya que no 'detecta' los \n.
 *			-Las opciones aunque se puedan poner tipo 'char' se ponen en string para evitar problemas
 *			de salto de lineas.
 */
